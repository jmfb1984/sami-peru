  ...
  <section id="main">
    <div class="d-block d-md-none mb-2">
      <b-button
        ...
        class="mb-1"
        block
        @click="repo_come_segu_cier_camp_regi_gene()"
      >
        <feather-icon
          icon="SearchIcon"
      ...
      <b-button
        variant="danger"
        block
        @click="repo_come_segu_cier_camp_regi_limp()"
      >
        <feather-icon
          icon="FileIcon"
          class="mr-50"
    ...
    <div class="d-none d-md-flex align-items-center justify-content-end mb-2">
      ...
      <b-button
        ...
        @click="repo_come_segu_cier_camp_regi_exce()"
      >
        <feather-icon
          icon="DownloadIcon"
          class="mr-50"
    ...
    <b-row>
      <b-col>
        <b-card>
          <JqxGrid
            ref="repo_come_segu_cier_camp_regi_grid_glob"
            :width="'100%'"
            :height="height"
            ...
            :showaggregates="true"
            :scrollmode="'logical'"
            @rowdoubleclick="repo_come_segu_cier_camp_regi_deta($event)"
          />
        </b-card>
      </b-col>
    </b-row>
    <vs-popup
      title="Seguimiento Cierre Campaña Zona"
      :active.sync="popupActive"
      fullscreen
      :background-color-popup="clasePopUp"
      @close="repo_come_segu_cier_camp_regi_deta_cerr()"
    >
      <b-row>
        <b-col>
          <div class="d-flex align-items-center justify-content-end mb-2">
            <b-button
              variant="success"
              class="ml-1 d-none d-lg-block"
              @click="repo_come_segu_cier_camp_regi_deta_exce()"
            >
              <feather-icon
                icon="DownloadIcon"
                class="mr-50"
      ...
      <b-row>
        <b-col>
          <JqxGrid
            ref="repo_come_segu_cier_camp_regi_grid_deta"
            :width="'100%'"
            :height="heightDetalle"
            :columngroups="columnsGroupDetalle"
...
export default {
  ...
  mounted() {
    ...
    this.repo_come_segu_cier_camp_regi_visi()
  },
  created() {
  ...
  methods: {
    ...
    async repo_come_segu_cier_camp_regi_visi() {
      try {
        await axios({
          method: 'post',
          ...
          data: {
            ...
            codi_prog: 'repo_come_segu_cier_camp_regi',
          },
        })
      } catch (error) {
        setTimeout(() => {
    ...
    handleWindowResize() {
      this.columnsGlobal = [
        ...
        },
        {
          ...
          columngroup: 'tota',
          cellclassname: this.repo_come_segu_cier_camp_regi_cump_tota_clas,
        },
        {
          text: 'Pend. Fact.',
        ...
        },
        {
          ...
          columngroup: 'tota',
          cellsrenderer: this.repo_come_segu_cier_camp_regi_dife_tota_clas,
        },
        {
          text: 'Objetivo',
          datafield: 'obje_inco',
        ...
        },
        {
          ...
          columngroup: 'inco',
          cellclassname: this.repo_come_segu_cier_camp_regi_cump_inco_clas,
        },
        {
          text: 'Pend. Fact.',
        ...
        },
        {
          ...
          columngroup: 'rete',
          cellclassname: this.repo_come_segu_cier_camp_regi_cump_rete_clas,
        },
        {
          text: 'Pend. Fact.',
        ...
        },
        {
          ...
          columngroup: 'rete',
          cellsrenderer: this.repo_come_segu_cier_camp_regi_dife_rete_clas,
        },
        {
          text: 'nume acti',
          datafield: 'nume_acti',
        ...
        },
        {
          ...
          columngroup: 'acti',
          cellclassname: this.repo_come_segu_cier_camp_regi_porc_acti_clas,
        },
        {
          text: '% Acti. Pend.',
        ...
        },
        {
          ...
          columngroup: 'cons',
          cellsrenderer: this.repo_come_segu_cier_camp_regi_obje_rete_cons_clas,
        },
        {
          text: 'Facturado',
        ...
        },
        {
          ...
          columngroup: 'cons',
          cellclassname: this
            .repo_come_segu_cier_camp_regi_cump_fact_rete_cons_clas,
        },
        {
          text: 'Pend. Fact.',
        ...
        },
        {
          ...
          columngroup: 'cons_segu',
          cellclassname: this
            .repo_come_segu_cier_camp_regi_cump_fact_rete_cons_segu_clas,
        },
        {
          text: 'Pend. Fact.',
        ...
        },
        {
          ...
          columngroup: 'cons_terc',
          cellclassname: this
            .repo_come_segu_cier_camp_regi_cump_fact_rete_cons_terc_clas,
        },
        {
          text: 'Pend. Fact.',
        ...
        },
        {
          ...
          columngroup: 'cons_cuar',
          cellclassname: this
            .repo_come_segu_cier_camp_regi_cump_fact_rete_cons_cuar_clas,
        },
        {
          text: 'Pend. Fact.',
        ...
        },
        {
          ...
          columngroup: 'pe21',
          cellsrenderer: this.repo_come_segu_cier_camp_regi_obje_pe21_clas,
        },
        {
          text: 'Ret. Peg21',
          datafield: 'fact_pe21',
        ...
        },
        {
          ...
          columngroup: 'pe21',
          cellclassname: this.repo_come_segu_cier_camp_regi_porc_pe21_clas,
        },
        {
          text: 'Pend. Fact.',
        ...
        },
        {
          ...
          columngroup: 'pe42',
          cellsrenderer: this.repo_come_segu_cier_camp_regi_obje_pe42_clas,
        },
        {
          text: 'Ret. Peg42',
          datafield: 'fact_pe42',
        ...
        },
        {
          ...
          columngroup: 'pe42',
          cellclassname: this.repo_come_segu_cier_camp_regi_porc_pe42_clas,
        },
        {
          text: 'Pend. Fact.',
        ...
        },
        {
          ...
          columngroup: 'pe63',
          cellsrenderer: this.repo_come_segu_cier_camp_regi_obje_pe63_clas,
        },
        {
          text: 'Ret. Peg63',
          datafield: 'fact_pe63',
        ...
        },
        {
          ...
          columngroup: 'pe63',
          cellclassname: this.repo_come_segu_cier_camp_regi_porc_pe63_clas,
        },
        {
          text: 'Pend. Fact.',
        ...
        },
        {
          ...
          columngroup: 'suma',
          cellsrenderer: this.repo_come_segu_cier_camp_regi_obje_pegs_clas,
        },
        {
          text: 'Ret. Pegs',
          datafield: 'fact_pegs',
        ...
        },
        {
          ...
          columngroup: 'suma',
          cellclassname: this.repo_come_segu_cier_camp_regi_porc_pegs_clas,
        },
        {
          text: 'Pend. Fact.',
        ...
        },
        {
          ...
          columngroup: 'rein',
          cellsrenderer: this.repo_come_segu_cier_camp_regi_obje_rein_clas,
        },
        {
          text: 'Facturado',
          datafield: 'fact_rein',
        ...
        },
        {
          ...
          columngroup: 'rein',
          cellclassname: this.repo_come_segu_cier_camp_regi_porc_rein_clas,
        },
        {
          text: 'Pend. Fact.',
        ...
        },
        {
          ...
          columngroup: 'capi',
          cellclassname: this.repo_come_segu_cier_camp_regi_fact_capi_clas,
        },
        {
          text: 'Capi. Pend.',
          datafield: 'pend_capi',
        ...
        },
        {
          ...
          columngroup: 'capi',
          cellsrenderer: this.repo_come_segu_cier_camp_regi_pend_capi_obje_clas,
        },
        {
          text: 'Valor',
          datafield: 'valo_docu',
        ...
        },
        {
          ...
          columngroup: 'cobr',
          cellclassname: this.repo_come_segu_cier_camp_regi_porc_21di_clas,
        },
        {
          text: 'Saldo Actu.',
          datafield: 'sald_docu',
      ...
      if (this.popupActiveCodigo !== '') {
        ...
        this.columnsDetalle = [
            ...
            aggregates: [
              {
                ...
                T: function(aggregatedValue, currentValue, column, record) {
                  ...
                  sumaFact += record.acti_fina_ante
                  sumaObje += record.obje_acti
                  let total = 0
                  // eslint-disable-next-line
                  if (parseInt(sumaObje) > 0 && parseInt(sumaFact) > 0) {
                    // eslint-disable-next-line
                    total = parseFloat(sumaObje) / parseInt(sumaFact)
                  }
                  total = parseFloat(total).toFixed(2)
                  return total
                },
          ...
          },
          {
            ...
            columngroup: 'tota',
            cellclassname: this
              .repo_come_segu_cier_camp_regi_sect_cump_tota_clas,
          },
          {
            text: 'Pend. Fact.',
            datafield: 'pend_fact_tota',
          ...
          },
          {
            ...
            columngroup: 'tota',
            cellsrenderer: this
              .repo_come_segu_cier_camp_regi_sect_dife_tota_clas,
          },
          {
            text: 'Objetivo',
            datafield: 'obje_inco',
          ...
          },
          {
            ...
            columngroup: 'inco',
            cellclassname: this
              .repo_come_segu_cier_camp_regi_sect_cump_inco_clas,
          },
          {
            text: 'Pend. Fact.',
            datafield: 'pend_fact_inco',
          ...
          },
          {
            ...
            columngroup: 'rete',
            cellclassname: this
              .repo_come_segu_cier_camp_regi_sect_cump_rete_clas,
          },
          {
            text: 'Pend. Fact.',
            datafield: 'pend_fact_rete',
          ...
          },
          {
            ...
            columngroup: 'rete',
            cellsrenderer: this
              .repo_come_segu_cier_camp_regi_sect_dife_rete_clas,
          },
          {
            text: 'nume acti',
            datafield: 'nume_acti',
          ...
          },
          {
            ...
            columngroup: 'acti',
            cellclassname: this
              .repo_come_segu_cier_camp_regi_sect_porc_acti_clas,
          },
          {
            text: '% Acti. Pend.',
            datafield: 'porc_acti_pend',
          ...
          },
          {
            ...
            columngroup: 'cons',
            cellsrenderer: this
              .repo_come_segu_cier_camp_regi_sect_obje_rete_cons_clas,
          },
          {
            text: 'Facturado',
            datafield: 'fact_rete_cons',
          ...
          },
          {
            ...
            columngroup: 'cons',
            cellclassname: this
              .repo_come_segu_cier_camp_regi_sect_cump_fact_rete_cons_clas,
          },
          {
            text: 'Pend. Fact.',
            datafield: 'pend_fact_rete_cons',
          ...
          },
          {
            ...
            columngroup: 'cons_segu',
            cellclassname: this
              .repo_come_segu_cier_camp_regi_sect_cump_fact_rete_cons_segu_clas,
          },
          {
            text: 'Pend. Fact.',
            datafield: 'pend_fact_rete_cons_segu',
          ...
          },
          {
            ...
            columngroup: 'cons_terc',
            cellclassname: this
              .repo_come_segu_cier_camp_regi_sect_cump_fact_rete_cons_terc_clas,
          },
          {
            text: 'Pend. Fact.',
            datafield: 'pend_fact_rete_cons_terc',
          ...
          },
          {
            ...
            columngroup: 'cons_cuar',
            cellclassname: this
              .repo_come_segu_cier_camp_regi_sect_cump_fact_rete_cons_cuar_clas,
          },
          {
            text: 'Pend. Fact.',
            datafield: 'pend_fact_rete_cons_cuar',
          ...
          },
          {
            ...
            columngroup: 'pe21',
            cellclassname: this
              .repo_come_segu_cier_camp_regi_sect_porc_pe21_clas,
          },
          {
            text: 'Pend. Fact.',
            datafield: 'pend_fact_pe21',
          ...
          },
          {
            ...
            columngroup: 'pe42',
            cellsrenderer: this
              .repo_come_segu_cier_camp_regi_sect_obje_pe42_clas,
          },
          {
            text: 'Ret. peg42',
            datafield: 'fact_pe42',
          ...
          },
          {
            ...
            columngroup: 'pe42',
            cellclassname: this
              .repo_come_segu_cier_camp_regi_sect_porc_pe42_clas,
          },
          {
            text: 'Pend. Fact.',
            datafield: 'pend_fact_pe42',
          ...
          },
          {
            ...
            columngroup: 'pe63',
            cellsrenderer: this
              .repo_come_segu_cier_camp_regi_sect_obje_pe63_clas,
          },
          {
            text: 'Ret. Peg63',
            datafield: 'fact_pe63',
          ...
          },
          {
            ...
            columngroup: 'pe63',
            cellclassname: this
              .repo_come_segu_cier_camp_regi_sect_porc_pe63_clas,
          },
          {
            text: 'Pend. Fact.',
            datafield: 'pend_fact_pe63',
          ...
          },
          {
            ...
            columngroup: 'suma',
            cellsrenderer: this
              .repo_come_segu_cier_camp_regi_sect_obje_pegs_clas,
          },
          {
            text: 'Ret. Pegs',
            datafield: 'fact_pegs',
          ...
          },
          {
            ...
            columngroup: 'suma',
            cellclassname: this
              .repo_come_segu_cier_camp_regi_sect_porc_pegs_clas,
          },
          {
            text: 'Pend. Fact.',
            datafield: 'pend_fact_pegs',
          ...
          },
          {
            ...
            columngroup: 'rein',
            cellsrenderer: this
              .repo_come_segu_cier_camp_regi_sect_obje_rein_clas,
          },
          {
            text: 'Facturado',
            datafield: 'fact_rein',
          ...
          },
          {
            ...
            columngroup: 'rein',
            cellclassname: this
              .repo_come_segu_cier_camp_regi_sect_porc_rein_clas,
          },
          {
            text: 'Pend. Fact.',
            datafield: 'pend_fact_rein',
          ...
          },
          {
            ...
            columngroup: 'capi',
            cellclassname: this
              .repo_come_segu_cier_camp_regi_sect_fact_capi_clas,
          },
          {
            text: 'Capi. Pend.',
            datafield: 'pend_capi',
          ...
          },
          {
            ...
            columngroup: 'capi',
            cellsrenderer: this
              .repo_come_segu_cier_camp_regi_sect_pend_capi_obje_clas,
          },
          {
            text: 'Valor',
            datafield: 'valo_docu',
          ...
          },
          {
            ...
            columngroup: 'cobr',
            cellclassname: this
              .repo_come_segu_cier_camp_regi_sect_porc_21di_clas,
          },
          {
            text: 'Saldo Actu.',
            datafield: 'sald_docu',
      ...
      if (
        typeof this.$refs.repo_come_segu_cier_camp_regi_grid_glob
        !== 'undefined'
      ) {
        if (window.innerHeight - 300 < 350) {
          this.height = '350px'
        ...
        this.$refs.repo_come_segu_cier_camp_regi_grid_glob.columns = this.columnsGlobal
        this.$refs.repo_come_segu_cier_camp_regi_grid_glob.height = this.height
      }
      if (
        typeof this.$refs.repo_come_segu_cier_camp_regi_grid_deta
        !== 'undefined'
      ) {
        this.$refs.repo_come_segu_cier_camp_regi_grid_deta.columns = this.columnsDetalle
        this.$refs.repo_come_segu_cier_camp_regi_grid_deta.height = this.heightDetalle
      }
    },
    onChangeVariable() {
      this.$refs.repo_come_segu_cier_camp_regi_grid_glob.beginupdate()
      this.$refs.repo_come_segu_cier_camp_regi_grid_glob.hidecolumn('obje_tota')
      this.$refs.repo_come_segu_cier_camp_regi_grid_glob.hidecolumn('fact_tota')
      this.$refs.repo_come_segu_cier_camp_regi_grid_glob.hidecolumn(
        'cump_fact_tota',
      )
      this.$refs.repo_come_segu_cier_camp_regi_grid_glob.hidecolumn(
        'pend_fact_tota',
      )
      this.$refs.repo_come_segu_cier_camp_regi_grid_glob.hidecolumn('tota_tota')
      this.$refs.repo_come_segu_cier_camp_regi_grid_glob.hidecolumn('cump_tota')
      this.$refs.repo_come_segu_cier_camp_regi_grid_glob.hidecolumn('dife_tota')
      this.$refs.repo_come_segu_cier_camp_regi_grid_glob.hidecolumn('obje_inco')
      this.$refs.repo_come_segu_cier_camp_regi_grid_glob.hidecolumn('fact_inco')
      this.$refs.repo_come_segu_cier_camp_regi_grid_glob.hidecolumn(
        'cump_fact_inco',
      )
      this.$refs.repo_come_segu_cier_camp_regi_grid_glob.hidecolumn(
      ...
      this.$refs.repo_come_segu_cier_camp_regi_grid_glob.hidecolumn('tota_inco')
      this.$refs.repo_come_segu_cier_camp_regi_grid_glob.hidecolumn('cump_inco')
      this.$refs.repo_come_segu_cier_camp_regi_grid_glob.hidecolumn('obje_rete')
      this.$refs.repo_come_segu_cier_camp_regi_grid_glob.hidecolumn('fact_rete')
      this.$refs.repo_come_segu_cier_camp_regi_grid_glob.hidecolumn(
        'cump_fact_rete',
      )
      this.$refs.repo_come_segu_cier_camp_regi_grid_glob.hidecolumn(
      ...
      this.$refs.repo_come_segu_cier_camp_regi_grid_glob.hidecolumn('tota_rete')
      this.$refs.repo_come_segu_cier_camp_regi_grid_glob.hidecolumn('cump_rete')
      this.$refs.repo_come_segu_cier_camp_regi_grid_glob.hidecolumn('dife_rete')
      this.$refs.repo_come_segu_cier_camp_regi_grid_glob.hidecolumn(
        'fact_rete_cons_ante',
      )
      this.$refs.repo_come_segu_cier_camp_regi_grid_glob.hidecolumn(
      ...
      this.$refs.repo_come_segu_cier_camp_regi_grid_glob.hidecolumn('obje_acti')
      this.$refs.repo_come_segu_cier_camp_regi_grid_glob.hidecolumn('porc_acti')
      this.$refs.repo_come_segu_cier_camp_regi_grid_glob.hidecolumn(
        'nume_pedi_acti',
      )
      this.$refs.repo_come_segu_cier_camp_regi_grid_glob.hidecolumn(
      ...
      this.$refs.repo_come_segu_cier_camp_regi_grid_glob.hidecolumn('obje_pe21')
      this.$refs.repo_come_segu_cier_camp_regi_grid_glob.hidecolumn('fact_pe21')
      this.$refs.repo_come_segu_cier_camp_regi_grid_glob.hidecolumn('porc_pe21')
      this.$refs.repo_come_segu_cier_camp_regi_grid_glob.hidecolumn(
        'pend_fact_pe21',
      )
      this.$refs.repo_come_segu_cier_camp_regi_grid_glob.hidecolumn('tota_pe21')
      this.$refs.repo_come_segu_cier_camp_regi_grid_glob.hidecolumn('cump_pe21')
      this.$refs.repo_come_segu_cier_camp_regi_grid_glob.hidecolumn(
        'fact_pe42_ante',
      )
      this.$refs.repo_come_segu_cier_camp_regi_grid_glob.hidecolumn('obje_pe42')
      this.$refs.repo_come_segu_cier_camp_regi_grid_glob.hidecolumn('fact_pe42')
      this.$refs.repo_come_segu_cier_camp_regi_grid_glob.hidecolumn('porc_pe42')
      this.$refs.repo_come_segu_cier_camp_regi_grid_glob.hidecolumn(
        'pend_fact_pe42',
      )
      this.$refs.repo_come_segu_cier_camp_regi_grid_glob.hidecolumn('tota_pe42')
      this.$refs.repo_come_segu_cier_camp_regi_grid_glob.hidecolumn('cump_pe42')
      this.$refs.repo_come_segu_cier_camp_regi_grid_glob.hidecolumn(
        'fact_pe63_ante',
      )
      this.$refs.repo_come_segu_cier_camp_regi_grid_glob.hidecolumn('obje_pe63')
      this.$refs.repo_come_segu_cier_camp_regi_grid_glob.hidecolumn('fact_pe63')
      this.$refs.repo_come_segu_cier_camp_regi_grid_glob.hidecolumn('porc_pe63')
      this.$refs.repo_come_segu_cier_camp_regi_grid_glob.hidecolumn(
        'pend_fact_pe63',
      )
      this.$refs.repo_come_segu_cier_camp_regi_grid_glob.hidecolumn('tota_pe63')
      this.$refs.repo_come_segu_cier_camp_regi_grid_glob.hidecolumn('cump_pe63')
      this.$refs.repo_come_segu_cier_camp_regi_grid_glob.hidecolumn(
        'fact_pegs_ante',
      )
      this.$refs.repo_come_segu_cier_camp_regi_grid_glob.hidecolumn('obje_pegs')
      this.$refs.repo_come_segu_cier_camp_regi_grid_glob.hidecolumn('fact_pegs')
      this.$refs.repo_come_segu_cier_camp_regi_grid_glob.hidecolumn('porc_pegs')
      this.$refs.repo_come_segu_cier_camp_regi_grid_glob.hidecolumn(
        'pend_fact_pegs',
      )
      this.$refs.repo_come_segu_cier_camp_regi_grid_glob.hidecolumn('tota_pegs')
      this.$refs.repo_come_segu_cier_camp_regi_grid_glob.hidecolumn('cump_pegs')
      this.$refs.repo_come_segu_cier_camp_regi_grid_glob.hidecolumn(
        'fact_rein_ante',
      )
      this.$refs.repo_come_segu_cier_camp_regi_grid_glob.hidecolumn('obje_rein')
      this.$refs.repo_come_segu_cier_camp_regi_grid_glob.hidecolumn('fact_rein')
      this.$refs.repo_come_segu_cier_camp_regi_grid_glob.hidecolumn('porc_rein')
      this.$refs.repo_come_segu_cier_camp_regi_grid_glob.hidecolumn(
        'pend_fact_rein',
      )
      this.$refs.repo_come_segu_cier_camp_regi_grid_glob.hidecolumn(
      ...
      this.$refs.repo_come_segu_cier_camp_regi_grid_glob.hidecolumn('cump_rein')
      this.$refs.repo_come_segu_cier_camp_regi_grid_glob.hidecolumn('fact_capi')
      this.$refs.repo_come_segu_cier_camp_regi_grid_glob.hidecolumn('obje_capi')
      this.$refs.repo_come_segu_cier_camp_regi_grid_glob.hidecolumn('pend_capi')
      this.$refs.repo_come_segu_cier_camp_regi_grid_glob.hidecolumn(
        'pend_capi_obje',
      )
      this.$refs.repo_come_segu_cier_camp_regi_grid_glob.hidecolumn('valo_docu')
      this.$refs.repo_come_segu_cier_camp_regi_grid_glob.hidecolumn('obje_docu')
      this.$refs.repo_come_segu_cier_camp_regi_grid_glob.hidecolumn('pend_cobr')
      this.$refs.repo_come_segu_cier_camp_regi_grid_glob.hidecolumn('porc_21di')
      this.$refs.repo_come_segu_cier_camp_regi_grid_glob.hidecolumn('sald_21di')
      this.$refs.repo_come_segu_cier_camp_regi_grid_glob.hidecolumn('sald_docu')
      this.$refs.repo_come_segu_cier_camp_regi_grid_glob.hidecolumn('porc_docu')
      this.$refs.repo_come_segu_cier_camp_regi_grid_glob.hidecolumn('pppp_fact')
      this.$refs.repo_come_segu_cier_camp_regi_grid_glob.hidecolumn('pppp_rece')
      this.$refs.repo_come_segu_cier_camp_regi_grid_glob.hidecolumn('nive_lide')
      this.$refs.repo_come_segu_cier_camp_regi_grid_glob.hidecolumn(
        'nive_lide_proy',
      )

      if (this.variable === '0') {
        this.$refs.repo_come_segu_cier_camp_regi_grid_glob.showcolumn(
          'obje_tota',
        )
        this.$refs.repo_come_segu_cier_camp_regi_grid_glob.showcolumn(
          'fact_tota',
      ...
      this.$refs.repo_come_segu_cier_camp_regi_grid_glob.endupdate()
    },
    repo_come_segu_cier_camp_limp() {
      ...
      this.codigoRegion = '0'
      this.$refs.repo_come_segu_cier_camp_regi_grid_glob.clear()
      this.$refs.repo_come_segu_cier_camp_regi_grid_glob.clearselection()
    },
    repo_come_segu_cier_camp_regi_cump_tota_clas(row, columnfield, value) {
      const dataRecord = this.$refs.repo_come_segu_cier_camp_regi_grid_glob.getrowdata(
        row,
      )
      // eslint-disable-next-line
    ...
    repo_come_segu_cier_camp_regi_cump_inco_clas(row, columnfield, value) {
      const dataRecord = this.$refs.repo_come_segu_cier_camp_regi_grid_glob.getrowdata(
        row,
      )
      // eslint-disable-next-line
    ...
    repo_come_segu_cier_camp_regi_cump_rete_clas(row, columnfield, value) {
      const dataRecord = this.$refs.repo_come_segu_cier_camp_regi_grid_glob.getrowdata(
        row,
      )
      // eslint-disable-next-line
    ...
    repo_come_segu_cier_camp_regi_porc_acti_clas(row, columnfield, value) {
      const dataRecord = this.$refs.repo_come_segu_cier_camp_regi_grid_glob.getrowdata(
        row,
      )
    ...
    repo_come_segu_cier_camp_regi_obje_rete_cons_clas(row, columnfield, value) {
      const dataRecord = this.$refs.repo_come_segu_cier_camp_regi_grid_glob.getrowdata(
        row,
      )
      // eslint-disable-next-line
      ...
      if (objeReteSist === 0) {
        return `<div class = "jqx-grid-cell-middle-align" style="margin-top: 8.5px;">${value}</div>`
      }
      if (porcReteCons >= 100) {
        return `<div class = "jqx-grid-cell-middle-align" style="margin-top: 6.5px; color: #00c602 ; font-weight: bold; font-size : 14px;">${value}</div>`
      }
      if (porcReteCons >= 80 && porcReteCons < 100) {
        return `<div class = "jqx-grid-cell-middle-align" style="margin-top: 6.5px; color: #ecaf00; font-weight: bold; font-size : 14px;">${value}</div>`
      }
      return `<div class = "jqx-grid-cell-middle-align" style="margin-top: 6.5px; color: #ff3f39; font-weight: bold; font-size : 14px;">${value}</div>`
    },
    repo_come_segu_cier_camp_regi_dife_tota_clas(row, columnfield, value) {
      // eslint-disable-next-line
    ...
    repo_come_segu_cier_camp_regi_dife_rete_clas(row, columnfield, value) {
      // eslint-disable-next-line
      const difeRete = parseInt(value)
    ...
    repo_come_segu_cier_camp_regi_pend_capi_obje_clas(row, columnfield, value) {
      // eslint-disable-next-line
      const difeRete = parseInt(value)
      if (difeRete >= 0) {
        return `<div class = "jqx-grid-cell-middle-align" style="margin-top: 8.5px;">${value}</div>`
    ...
    repo_come_segu_cier_camp_regi_porc_21di_clas(row, columnfield, value) {
      const valoData = parseFloat(value).toFixed(2)
      if (valoData === 0) {
        return ''
      }
    ...
    repo_come_segu_cier_camp_regi_obje_pe21_clas(row, columnfield, value) {
      const dataRecord = this.$refs.repo_come_segu_cier_camp_regi_grid_glob.getrowdata(
        row,
      )
      // eslint-disable-next-line
    ...
    repo_come_segu_cier_camp_regi_porc_pe21_clas(row, columnfield, value) {
      const dataRecord = this.$refs.repo_come_segu_cier_camp_regi_grid_glob.getrowdata(
        row,
      )
      // eslint-disable-next-line
    ...
    repo_come_segu_cier_camp_regi_obje_pe42_clas(row, columnfield, value) {
      const dataRecord = this.$refs.repo_come_segu_cier_camp_regi_grid_glob.getrowdata(
        row,
      )
      // eslint-disable-next-line
    ...
    repo_come_segu_cier_camp_regi_porc_pe42_clas(row, columnfield, value) {
      const dataRecord = this.$refs.repo_come_segu_cier_camp_regi_grid_glob.getrowdata(
        row,
      )
      // eslint-disable-next-line
    ...
    repo_come_segu_cier_camp_regi_obje_pe63_clas(row, columnfield, value) {
      const dataRecord = this.$refs.repo_come_segu_cier_camp_regi_grid_glob.getrowdata(
        row,
      )
      // eslint-disable-next-line
    ...
    repo_come_segu_cier_camp_regi_porc_pe63_clas(row, columnfield, value) {
      const dataRecord = this.$refs.repo_come_segu_cier_camp_regi_grid_glob.getrowdata(
        row,
      )
      // eslint-disable-next-line
    ...
    repo_come_segu_cier_camp_regi_obje_pegs_clas(row, columnfield, value) {
      const dataRecord = this.$refs.repo_come_segu_cier_camp_regi_grid_glob.getrowdata(
        row,
      )
      // eslint-disable-next-line
    ...
    repo_come_segu_cier_camp_regi_porc_pegs_clas(row, columnfield, value) {
      const dataRecord = this.$refs.repo_come_segu_cier_camp_regi_grid_glob.getrowdata(
        row,
      )
      // eslint-disable-next-line
    ...
    repo_come_segu_cier_camp_regi_obje_rein_clas(row, columnfield, value) {
      const dataRecord = this.$refs.repo_come_segu_cier_camp_regi_grid_glob.getrowdata(
        row,
      )
      // eslint-disable-next-line
    ...
    repo_come_segu_cier_camp_regi_porc_rein_clas(row, columnfield, value) {
      const dataRecord = this.$refs.repo_come_segu_cier_camp_regi_grid_glob.getrowdata(
        row,
      )
      // eslint-disable-next-line
    ...
    repo_come_segu_cier_camp_regi_fact_capi_clas(row, columnfield, value) {
      const dataRecord = this.$refs.repo_come_segu_cier_camp_regi_grid_glob.getrowdata(
        row,
      )
      // eslint-disable-next-line
    ...
    repo_come_segu_cier_camp_regi_limp() {
      this.objetivoIncorporacion = '0'
      this.totalFacturadoIncorporacion = '0'
      this.cumplimientoFacturadoIncorporacion = '0.00'
      this.totalPendienteFacturadoIncorporacion = '0'
    ...
    async repo_come_segu_cier_camp_regi_gene() {
      this.$vs.loading({
      ...
      if (
        ...
        this.$toast(
          {
            ...
            props: {
              ...
              icon: 'AlertTriangleIcon',
              variant: 'danger',
              text: 'Campo region es obligatorio.',
            },
          },
          {
            position: 'bottom-right',
        ...
        this.repo_come_segu_cier_camp_regi_limp()
        this.codigoCampana = this.seleccionCampana
        this.codigoRegion = this.seleccionRegion
        ...
        try {
          const servicio = await axios({
            method: 'post',
            url: `${store.state.app.webService}/sami_v1/repo_come_segu_cier_camp_regi/segu_cier_camp_regi_gene`,
            timeout: `${1000 * store.state.app.timeout}`,
            data: {
              codi_usua: this.$session.get('codigoUsuario'),
              codi_acce: this.userData.codigoAcceso,
              codi_camp: this.codigoCampana,
              codi_area: this.codigoRegion,
              camp_actu: campActu,
            },
          })
          ...
          this.$refs.repo_come_segu_cier_camp_regi_grid_glob.updatebounddata(
            'cells',
          )
          setTimeout(() => {
            this.$vs.loading.close()
    ...
    async repo_come_segu_cier_camp_regi_exce() {
      this.$vs.loading({
        color: $themeColors.primary,
      })
      const dataInfoGlob = this.$refs.repo_come_segu_cier_camp_regi_grid_glob.getdatainformation()
      ...
      if (dataRowsGlob === 0) {
        ...
        try {
          const servicio = await axios({
            method: 'post',
            url: `${store.state.app.webService}/sami_v1/repo_come_segu_cier_camp_regi/segu_cier_camp_regi_exce`,
            timeout: `${1000 * store.state.app.timeout}`,
            data: {
              codi_usua: this.$session.get('codigoUsuario'),
              codi_acce: this.userData.codigoAcceso,
              ...
              data_glob: this.$refs.repo_come_segu_cier_camp_regi_grid_glob.exportdata(
                'json',
                null,
                true,
                null,
              ...
              data_esta: this.$refs.repo_come_segu_cier_camp_regi_grid_glob.getstate(),
            },
          })
    ...
    repo_come_segu_cier_camp_regi_sect_cump_tota_clas(row, columnfield, value) {
      const dataRecord = this.$refs.repo_come_segu_cier_camp_regi_grid_deta.getrowdata(
        row,
      )
      // eslint-disable-next-line
      const objeTota = parseInt(dataRecord.obje_tota)
    ...
    repo_come_segu_cier_camp_regi_sect_cump_inco_clas(row, columnfield, value) {
      const dataRecord = this.$refs.repo_come_segu_cier_camp_regi_grid_deta.getrowdata(
        row,
      )
      // eslint-disable-next-line
    ...
    repo_come_segu_cier_camp_regi_sect_cump_rete_clas(row, columnfield, value) {
      const dataRecord = this.$refs.repo_come_segu_cier_camp_regi_grid_deta.getrowdata(
        row,
      )
      // eslint-disable-next-line
    ...
    repo_come_segu_cier_camp_regi_sect_porc_acti_clas(row, columnfield, value) {
      const dataRecord = this.$refs.repo_come_segu_cier_camp_regi_grid_deta.getrowdata(
        row,
      )
      const objeActi = parseFloat(dataRecord.obje_acti).toFixed(2)
    ...
    repo_come_segu_cier_camp_regi_sect_obje_pe21_clas(
      row,
      columnfield,
      value,
    ) {
    ...
    repo_come_segu_cier_camp_regi_sect_porc_pe21_clas(row, columnfield, value) {
      const dataRecord = this.$refs.repo_come_segu_cier_camp_regi_grid_deta.getrowdata(
        row,
      )
      // eslint-disable-next-line
    ...
    repo_come_segu_cier_camp_regi_sect_obje_pe42_clas(row, columnfield, value) {
      const dataRecord = this.$refs.repo_come_segu_cier_camp_regi_grid_deta.getrowdata(
        row,
      )
      // eslint-disable-next-line
    ...
    repo_come_segu_cier_camp_regi_sect_porc_pe42_clas(row, columnfield, value) {
      const dataRecord = this.$refs.repo_come_segu_cier_camp_regi_grid_deta.getrowdata(
        row,
      )
      // eslint-disable-next-line
    ...
    repo_come_segu_cier_camp_regi_sect_obje_pe63_clas(row, columnfield, value) {
      const dataRecord = this.$refs.repo_come_segu_cier_camp_regi_grid_deta.getrowdata(
        row,
      )
      // eslint-disable-next-line
    ...
    repo_come_segu_cier_camp_regi_sect_porc_pe63_clas(row, columnfield, value) {
      const dataRecord = this.$refs.repo_come_segu_cier_camp_regi_grid_deta.getrowdata(
        row,
        // eslint-disable-next-line
      )
    ...
    repo_come_segu_cier_camp_regi_sect_obje_pegs_clas(row, columnfield, value) {
      const dataRecord = this.$refs.repo_come_segu_cier_camp_regi_grid_deta.getrowdata(
        row,
      )
      // eslint-disable-next-line
    ...
    repo_come_segu_cier_camp_regi_sect_porc_pegs_clas(row, columnfield, value) {
      const dataRecord = this.$refs.repo_come_segu_cier_camp_regi_grid_deta.getrowdata(
        row,
      )
      // eslint-disable-next-line
    ...
    repo_come_segu_cier_camp_regi_sect_obje_rein_clas(row, columnfield, value) {
      const dataRecord = this.$refs.repo_come_segu_cier_camp_regi_grid_deta.getrowdata(
        row,
      )
      // eslint-disable-next-line
    ...
    repo_come_segu_cier_camp_regi_sect_porc_rein_clas(row, columnfield, value) {
      const dataRecord = this.$refs.repo_come_segu_cier_camp_regi_grid_deta.getrowdata(
        row,
      )
      // eslint-disable-next-line
    ...
    repo_come_segu_cier_camp_regi_sect_fact_capi_clas(row, columnfield, value) {
      const dataRecord = this.$refs.repo_come_segu_cier_camp_regi_grid_deta.getrowdata(
        row,
      )
      // eslint-disable-next-line
    ...
    repo_come_segu_cier_camp_regi_sect_porc_21di_clas(row, columnfield, value) {
      const valoData = parseFloat(value).toFixed(2)
      if (valoData === 0) {
        return ''
      }
    ...
    async repo_come_segu_cier_camp_regi_deta(event) {
      let args = {}
      args = event.args
      const row = args.rowindex
      const dataRecord = this.$refs.repo_come_segu_cier_camp_regi_grid_glob.getrowdata(row)
      ...
      try {
        const servicio = await axios({
          method: 'post',
          url: `${store.state.app.webService}/sami_v1/repo_come_segu_cier_camp_regi/segu_cier_camp_regi_deta_gene`,
          timeout: `${1000 * store.state.app.timeout}`,
          data: {
            codi_usua: this.$session.get('codigoUsuario'),
            codi_acce: this.userData.codigoAcceso,
        ...
        this.$refs.repo_come_segu_cier_camp_regi_grid_deta.updatebounddata(
          'cells',
        )
        setTimeout(() => {
          this.$vs.loading.close()
    ...
    repo_come_segu_cier_camp_regi_deta_cerr() {
      document.body.style.overflow = 'visible'
      document.getElementsByClassName('floating-nav')[0].style.zIndex = '620001'
      this.popupActiveCodigo = ''
    },
    async repo_come_segu_cier_camp_regi_deta_exce() {
      this.$vs.loading({
        color: $themeColors.primary,
      })
      const dataInfoDeta = this.$refs.repo_come_segu_cier_camp_regi_grid_deta.getdatainformation()
      ...
      if (dataRowsDeta === 0) {
        ...
        try {
          const servicio = await axios({
            method: 'post',
            url: `${store.state.app.webService}/sami_v1/repo_come_segu_cier_camp_regi/segu_cier_camp_regi_deta_exce`,
            timeout: `${1000 * store.state.app.timeout}`,
            data: {
              codi_usua: this.$session.get('codigoUsuario'),
              codi_acce: this.userData.codigoAcceso,
              data_glob: this.$refs.repo_come_segu_cier_camp_regi_grid_deta.exportdata(
                'json',
                null,
                true,
                null,
              ...
              data_esta: this.$refs.repo_come_segu_cier_camp_regi_grid_deta.getstate(),
            },
          })
          const datoHtml = await servicio.data.html
          setTimeout(() => {
